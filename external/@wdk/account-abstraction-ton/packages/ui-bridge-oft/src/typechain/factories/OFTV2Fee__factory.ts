...
import type { OFTV2Fee, OFTV2FeeInterface } from "../OFTV2Fee";
...
export class OFTV2Fee__factory {
  static readonly abi = _abi;
  static createInterface(): OFTV2FeeInterface {
    return new utils.Interface(_abi) as OFTV2FeeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OFTV2Fee {
    return new Contract(address, _abi, signerOrProvider) as OFTV2Fee;
  }
}
